                ...
                <div class="col mx-auto" >
                    ...
                    <c:forEach items="${cart.productLine}" var="pdl">
                        <div class="row m-0 p-1" style="background-color: #ECEEF0">
                            ...
                            <div class="col"><span class="align-middle">${pdl.product.price} ฿</span></div>
                            <div class="col">
                    ...
                    <div class="col-12 m-0 p-0">
                        <div class="text-right">
                            ...
                            <% } else {%>
                            <div>Total OrderPrice ${cart.totalPrice} ฿</div>
                            <div>Total Quantity ${cart.totalQuantity}</div>

                            <% }%>
                        </div>
                        <div class="bg-warning p-2 row m-0">
                            ...
                            <div class="col text-right">
                                <%
                                    ...
                                    if (cart == null) {
                                %>
                                <a href="Checkform?path=<%= request.getRequestURL()%>"><button type="button" class="btn btn-success" disabled>CHECK BILL</button></a> 
                                <% } else {%>
                                <a href="Checkform?path=<%= request.getRequestURL()%>"><button type="button" class="btn btn-success">CHECK BILL</button></a> 
                                <% }%>
                            </div>
